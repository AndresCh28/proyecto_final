...
export function DashboardPage() {
  ...
  return (
    <AppShell
      ...
      subtitle="Resumen operativo de comisiones, votaciones, solicitudes y avisos pendientes."
    >
      ...
      <div className="panel-grid">
        ...
        <section className="glass-card side-panel">
          ...
          <div className="quick-actions">
            <Link className="primary-button" to="/comisiones">
              Comisiones
            </Link>
      ...
      <div className="panel-grid">
        <section className="glass-card">
          <div className="section-head">
            <div>
              <span className="eyebrow">Comisiones</span>
